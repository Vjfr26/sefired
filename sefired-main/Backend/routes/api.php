...
Route::middleware([\App\Http\Middleware\ApiTokenMiddleware::class, 'throttle:120,1'])->group(function () {
    ...
    Route::middleware(['role:Admin', 'throttle:api_write'])->group(function () {
        ...
        // Reportes Internos
        Route::get('/reports/superintendencia',         [ReportController::class, 'getSuperintendencia']);
        Route::post('/reports/superintendencia/exportar', [ReportController::class, 'exportSuperintendencia']);
