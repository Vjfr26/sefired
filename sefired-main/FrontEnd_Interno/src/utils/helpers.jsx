...
export const PERMS_CATALOG = {
  home: {
    ...
    locked: true,
    actions: [
      { id: 'view', label: 'Ver panel de inicio' },
    ],
  },
  clientes: {
    ...
    actions: [
      ...
      { id: 'delete',        label: 'Eliminar cliente' },
      { id: 'block',         label: 'Bloquear / Desbloquear cliente' },
      { id: 'view_polizas',  label: 'Ver pólizas e historial' },
      { id: 'view_facturas', label: 'Ver facturas del cliente' },
      { id: 'renew',         label: 'Renovar póliza' },
      { id: 'adjust',        label: 'Ajustar póliza (estado, fechas, prima)' },
      { id: 'print',         label: 'Imprimir / exportar clientes y pólizas' },
    ],
  },
  vehiculos: {
    label: 'Vehículos',
    icon: '🚗',
    actions: [
      { id: 'view',   label: 'Ver listado de vehículos' },
      { id: 'create', label: 'Registrar nuevo vehículo' },
      { id: 'edit',   label: 'Editar datos del vehículo' },
  ...
  productos: {
    ...
    actions: [
      ...
      { id: 'delete',      label: 'Eliminar producto' },
      { id: 'manage_docs', label: 'Gestionar documentos del producto' },
    ],
  },
  tasas: {
  ...
  usuarios: {
    ...
    actions: [
      ...
      { id: 'delete',      label: 'Eliminar usuario' },
      { id: 'block',       label: 'Bloquear / Desbloquear usuario' },
      { id: 'perms',       label: 'Gestionar permisos de usuarios' },
      { id: 'change_role', label: 'Cambiar rol de usuario' },
    ],
  },
  reportes: {
    label: 'Reportes',
...
export const PERMISOS_POR_ROL = {
  'Admin': {
    home:         ['view'],
    clientes:     ['view', 'create', 'edit', 'delete', 'block', 'view_polizas', 'view_facturas', 'renew', 'adjust', 'print'],
    vehiculos:    ['view', 'create', 'edit', 'delete'],
    cotizaciones: ['view', 'create', 'edit', 'delete', 'emit'],
    productos:    ['view', 'edit', 'delete', 'manage_docs'],
  ...
  'Oficina': {
    home:         ['view'],
    clientes:     ['view', 'create', 'edit', 'block', 'view_polizas', 'view_facturas', 'renew', 'adjust', 'print'],
    vehiculos:    ['view', 'create', 'edit'],
  ...
  'Vendedor Sucursal': {
    home:         ['view'],
    clientes:     ['view', 'create', 'view_polizas', 'view_facturas'],
    vehiculos:    ['view', 'create'],
