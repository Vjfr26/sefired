...
const T = {
  es: {
    ...
    'f.terms':           'Acepto que LA VENEZOLANA DE SEGUROS Y VIDA C.A. / J&M procese mis datos para recibir información sobre seguros, de acuerdo con la',
    ...
    'chat.seguros.reply': 'En LA VENEZOLANA DE SEGUROS Y VIDA C.A. ofrecemos: 🚗 Vehículos, 🏠 Hogar, ❤️ Vida, 🏥 HCM/Salud, 🏢 Empresarial y 📋 Fianzas.',
  ...
  en: {
    ...
    'f.terms':     'I agree that LA VENEZOLANA DE SEGUROS Y VIDA C.A. / J&M may process my data to receive information about insurance, in accordance with the',
    ...
    'chat.seguros.reply': 'At LA VENEZOLANA DE SEGUROS Y VIDA C.A. we offer: 🚗 Vehicle, 🏠 Home, ❤️ Life, 🏥 Health, 🏢 Business and 📋 Bonds.',
    ...
    'footer.operated': 'Operated by INVERSIONES J&M, C.A. - All rights reserved.',
    'footer.backed':   'backed by LA VENEZOLANA DE SEGUROS Y VIDA C.A.',
    'soc.facebook': 'Facebook', 'soc.instagram': 'Instagram',
    'soc.twitter': 'Twitter / X', 'soc.linkedin': 'LinkedIn',
