...
const T = {
  es: {
    ...
    'f.terms':           'Acepto que LA VENEZOLANA DE SEGUROS Y VIDA C.A. procese mis datos para recibir información sobre seguros, de acuerdo con la',
  ...
  en: {
    ...
    'f.terms':     'I agree that LA VENEZOLANA DE SEGUROS Y VIDA C.A. may process my data to receive information about insurance, in accordance with the',
