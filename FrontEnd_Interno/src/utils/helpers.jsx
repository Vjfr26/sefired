...
export const PERMS_CATALOG = {
  ...
  cotizaciones: {
    ...
    actions: [
      ...
      { id: 'renew',        label: 'Renovar póliza desde cotización' },
      { id: 'print_poliza', label: 'Imprimir póliza emitida' },
      { id: 'adjust',       label: 'Editar póliza emitida (estado, fechas, prima)' },
    ],
  },
  productos: {
...
export const PERMISOS_POR_ROL = {
  'Admin': {
    ...
    cotizaciones: ['view', 'view_list', 'create', 'edit', 'delete', 'emit', 'underwrite', 'renew', 'print_poliza', 'adjust'],
  ...
  'Oficina': {
    ...
    cotizaciones: ['view', 'view_list', 'create', 'edit', 'emit', 'underwrite', 'renew', 'print_poliza', 'adjust'],
