...
const EXT_COLS = [
  ...
  ['nacionalidad_asegurado', 'Nacionalidad Asegurado'], ['cedula_asegurado', 'Cédula/RIF Asegurado'],
  ['primer_nombre_asegurado', 'Primer Nombre Aseg.'], ['segundo_nombre_asegurado', 'Segundo Nombre Aseg.'],
  ['primer_apellido_asegurado', 'Primer Apellido Aseg.'], ['segundo_apellido_asegurado', 'Segundo Apellido Aseg.'],
  ['fecha_nacimiento_asegurado', 'Fecha Nacimiento Aseg.'], ['sexo_asegurado', 'Sexo Asegurado'],
  ['direccion_asegurado', 'Dirección Asegurado'], ['ciudad_asegurado', 'Ciudad Asegurado'],
  ['estado_asegurado', 'Estado Asegurado'], ['telefono_asegurado', 'Teléfono Asegurado'],
