...
class VehiculoController extends Controller
{
    ...
    {
        $vehiculos = Vehiculo::with(['cliente.persona', 'solicitudes.polizas'])
            ->orderBy('id', 'desc')
            ->get()
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(
            $this->formatRow($vehiculo->load('cliente.persona')),
            201
        );
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(
            $this->formatRow($vehiculo->fresh()->load('cliente.persona'))
        );
    }
