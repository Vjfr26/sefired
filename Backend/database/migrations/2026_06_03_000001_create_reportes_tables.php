...
return new class extends Migration
{
    ...
    {
        Schema::create('reportes_externos_historial', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('reportes_externos_programaciones', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('reportes_externos_programaciones');
        Schema::dropIfExists('reportes_externos_historial');
    }
};
